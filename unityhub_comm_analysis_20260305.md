...
## Scope
- Target: user-space extracted Unity Hub binary at `$HOME/.local/opt/unityhub/unityhub`
...
## Launcher Changes
- `$HOME/bin/unityhub` now launches the extracted Unity Hub binary directly.
...
- Reusable capture helper added:
  - `gaming_ws/scripts/unityhub_trace_network.sh`
  - `gaming_ws/scripts/unityhub_sample_connections.sh`
...
### A) Normal launch re-test (`$HOME/bin/unityhub`)
- GPU was present on host (`GPU`, driver `580.126.09`).
...
- `timeout 25s $HOME/bin/unityhub` completed without a fatal GPU line.
...
- Command:
  - `gaming_ws/scripts/unityhub_trace_network.sh 30`
- Summary:
  - `53`: 19
  - `443`: 17
  - `0`: 44
...
- Command:
  - `gaming_ws/scripts/unityhub_trace_network.sh 180`
- Summary:
  - `53`: 23
  - `443`: 18
  - `0`: 44
...
### A) Method
- Command:
  - `gaming_ws/scripts/unityhub_sample_connections.sh 60 5`
...
- Repeated non-fatal warning:
  - missing `$HOME/.local/share/unity3d/prefs`
...
- A confirming `strace` run showed direct opens against:
  - `$HOME/.config/unityhub/skipRemoveConfirmation.json`
  - `$HOME/.config/unityhub/skipInstallInProgressWarning.json`
  - `$HOME/.config/unityhub/skipSignOutConfirmation.json`
  - `$HOME/.config/unityhub/projectOrganizationSetting.json`
- Evidence:
...
- The script now:
  ...
  - ensures `$HOME/.local/share/unity3d/prefs` exists with minimal XML root attributes so `EditorPrefLinux` can parse version metadata

### C) Verification after normalization
- Verification command:
  - `timeout 25s $HOME/bin/unityhub`
- Fresh stderr capture:
...
- The new main-process log window no longer contains:
  ...
  - `Malformed skip install in progress warning setting object. Received: {}`
  - `Malformed skip sign out confirmation setting object. Received: {}`
  - `EditorPrefLinux` ENOENT warnings for `$HOME/.local/share/unity3d/prefs`
...
### F) Bundled UI gating
- Local bundle inspection of `$HOME/.local/opt/unityhub/resources/app.asar` indicates:
...
- Evidence:
  - [unityhub_bundle_findings_20260306.md](gaming_ws/unityhub_bundle_findings_20260306.md)
...
- Source inspection:
  ...
  - `LicensingSdk.init()` spawns the bundled client binary:
    - `$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client`
...
- Standalone licensing-client state:
  ...
  - the client logs show it scans these local license locations:
    - `$HOME/.local/share/unity3d/Unity/*.ulf`
    - `$HOME/.local/share/unity3d/Unity/licenses/*.xml`
    - `$HOME/.config/unity3d/Unity/licenses/*.xml`
...
```bash
APPDIR=$HOME/.local/opt/unityhub
...
```bash
timeout 180s gaming_ws/scripts/unityhub_trace_network.sh 180
```
...
```bash
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --help
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --debug --showContext
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --debug --showEntitlements
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --debug --showAllEntitlements
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --debug --showRemoteEntitlements
$HOME/.local/opt/unityhub/UnityLicensingClient_V1/Unity.Licensing.Client --debug --activate-ulf --serial AAAA-BBBB-CCCC-DDDD
```

### Scenario Variant
```bash
gaming_ws/scripts/unityhub_trace_scenario.sh startup_bypass
gaming_ws/scripts/unityhub_trace_scenario.sh learn_nav
gaming_ws/scripts/unityhub_trace_scenario.sh community_nav
gaming_ws/scripts/unityhub_trace_scenario.sh install_editor_open
gaming_ws/scripts/unityhub_trace_scenario.sh install_editor_modules
gaming_ws/scripts/unityhub_trace_scenario.sh install_download_start
gaming_ws/scripts/unityhub_trace_scenario.sh licenses_preferences
gaming_ws/scripts/unityhub_trace_scenario.sh license_add_modal
gaming_ws/scripts/unityhub_trace_scenario.sh license_request_flow
gaming_ws/scripts/unityhub_trace_scenario.sh license_request_create_dialog
gaming_ws/scripts/unityhub_trace_scenario.sh license_request_portal_open
gaming_ws/scripts/unityhub_trace_scenario.sh license_file_picker_open
gaming_ws/scripts/unityhub_trace_scenario.sh license_activate_invalid_file
gaming_ws/scripts/unityhub_trace_scenario.sh license_activate_invalid_file_direct
gaming_ws/scripts/unityhub_trace_scenario.sh license_activate_invalid_serial
gaming_ws/scripts/unityhub_trace_scenario.sh signin_open
gaming_ws/scripts/unityhub_trace_scenario.sh licenses_preferences_signedin
gaming_ws/scripts/unityhub_trace_scenario.sh license_add_modal_signedin
gaming_ws/scripts/unityhub_trace_scenario.sh license_serial_open_signedin
gaming_ws/scripts/unityhub_trace_scenario.sh license_personal_activate_signedin
```
