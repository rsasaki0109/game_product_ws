...
export const BOSSES: EnemyDef[] = [
  {
    ...
    baseHp: 28,
    baseAttack: 4,
    intentPattern: ['attack', 'attack', 'buff', 'attack', 'defend', 'defend'],
    isBoss: true,
  ...
  },
  {
    ...
    baseHp: 28,
    baseAttack: 5,
    intentPattern: ['attack', 'defend', 'special', 'defend', 'attack'],
    isBoss: true,
    description: '火を吐く古竜',
  },
  {
    ...
    baseHp: 42,
    baseAttack: 6,
    intentPattern: ['attack', 'special', 'defend', 'attack', 'buff', 'attack'],
    isBoss: true,
